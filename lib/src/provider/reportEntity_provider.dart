...
import 'package:street_report/src/models/reportsEntity.dart';
import 'package:street_report/src/models/response_api.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:path/path.dart';

class ReportEntityProvider {
  List<LatLng> points = [];
  String _url = Enviroment.API_STREET_REPORT;
  String _api = "/api/reportsentity";
  BuildContext? context;
  Future? init(BuildContext context) {
    this.context = context;
  }

  Future<Stream> createWithImage(ReportEntity reportEntity, File image) async {
    try {
      ...
      request.fields['reportEntity'] = json.encode(<String, dynamic>{
        'id': reportEntity.id,
  ...
  Future<ResponseApi> create(ReportEntity reportEntity) async {
    try {
      Uri url = Uri.http(_url, '$_api/create');
      String bodyParams = json.encode(reportEntity);
